package com.microservices.loans.services.impl;
...
public class LoansServiceImpl implements ILoansService {
    ...
    private Loans createNewLoan(String mobileNumber) {
        ...
        long randomLoanNumber = 100000000000L + new Random().nextInt(900000000); // It can be duplicate - but for now let it be
